...
checkpoint="/home/iiitdwd/cocosda_wavlm/exps/exp_17thMay_step3/epoch=1-VEER=49.787-mindcf=1.000.ckpt"
b={}
...
testset = test_dataset_loader(
    list(glob.glob("/home/iiitdwd/cocosda_wavlm/data/I-MSV-Public-test-20230204T124223Z-001/I-MSV-Public-test/data/*.wav")),
    "",
    500,
    num_eval=15   
)
...
for idx, data in tqdm(enumerate(test_loader),total=len(test_loader)):
    ...
    if idx % 1000==0 or idx == len(test_loader)-1:
      torch.save(feats, "data_19thMay/test_emb_raw.pth")
    # feats[data[1][0]] = ref_feat
torch.save(feats, "data_19thMay/test_emb_wavlm3_public.pth")
