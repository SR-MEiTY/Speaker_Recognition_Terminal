...
#_--------------------------------------------------------------------------------------_
a=torch.load("/home/iiitdwd/cocosda_wavlm/exps/exp_21thMay_rawnet_step3/epoch=1-VEER=49.963-mindcf=1.000.ckpt",map_location=torch.device('cpu'))['state_dict']
b={}
for k in a:
...
torch.save(feats, "data_21stOct/test_emb_raw_private.pth")
