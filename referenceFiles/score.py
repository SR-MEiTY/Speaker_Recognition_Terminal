...
speaker_feat=torch.load("/home/iiitdwd/cocosda_wavlm/data_19thMay/test_emb_wavlm3_enrol21.pth")
test_feat=torch.load("/home/iiitdwd/cocosda_wavlm/data_21stOct/test_emb_wavlm_private.pth")
e=[]
...
p.to_csv("preds_asnorm_wavlm_private_nonorm.csv")
