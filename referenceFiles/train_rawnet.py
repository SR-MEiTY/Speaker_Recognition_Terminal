...
class SpeakerLightingModule(LightningModule):
    def __init__(self,**kwargs):
        super().__init__()
        print(kwargs)
        self.model = MainModelRawnet(**kwargs)
#        print(self.model.load_state_dict(state_dict['model'], strict=False))
        ...
        self.model.load_state_dict(torch.load("/home/iiitdwd/cocosda_wavlm/exps/exp_21thMay_rawnet_step2/last.ckpt")['state_dict'],strict=False)
        import math 
    ...
    def add_model_specific_args(parent_parser):
        ...
        parser.add_argument('--save_path',      type=str,   default="exps/exp_21thMay_rawnet_step3", help='Path for model and logs')
